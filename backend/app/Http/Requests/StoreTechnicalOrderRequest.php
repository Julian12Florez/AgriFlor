...
class StoreTechnicalOrderRequest extends FormRequest
{
    ...
    {
        return [
            'order_number' => ['required', 'string', 'unique:technical_orders,order_number'],
            ...
            'responsible_agronomist' => ['required', 'uuid', 'exists:users,id'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'farm_ids.required' => 'Debe seleccionar al menos una finca',
            ...
            'responsible_agronomist.required' => 'El agrónomo responsable es requerido',

{{--
    REMISION DE DESPACHO - Plantilla "AGRILOGISTIC" (corporativo sobrio)
    Identidad: verde profundo institucional, banda horizontal de encabezado,
    tabla con encabezado solido y filas alternadas, firmas en recuadro.
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; }
        ...
        .company-strip .sep { color: #A5D6A7; padding: 0 5px; }
        ...
        .info .val { width: 35%; font-size: 10px; color: #212121; }
        .info .val strong { color: #1B5E20; }
        ...
        .route .rlabel { font-size: 7.5px; color: #A5D6A7; letter-spacing: 1.4px; font-weight: normal; }
        .route .arrow { color: #C5E1A5; padding: 0 8px; }
        ...
        .zebra { background: #F4F8F0; }
        .c { text-align: center; }
        .r { text-align: right; }
        .qty { font-weight: bold; color: #1B5E20; }
        .muted { color: #757575; }
        .code { font-size: 8.4px; color: #455A64; }
        ...
        table.signs td.divider { width: 1px; padding: 0; border-left: 1px solid #C8E6C9; }
        .sign-role {
            font-size: 9.5px;
            font-weight: bold;
            color: #FFFFFF;
        ...
        .sign-prefill { font-size: 9px; color: #212121; }
        ...
        <tr>
            <td class="band-left">
                ...
                @else
                    ...
                    <div class="brand-tag">TRANSPORTE Y LOGISTICA AGRICOLA</div>
                @endif
            </td>
            <td class="band-right">
                <div class="doc-box">
